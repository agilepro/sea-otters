...
sub CreateSwimmerPage
{
    ...
    print OUTFILE "<h1 class=\"titletext\">$alias (2015)</h1>\n";
    if ($alias =~ /Swimmer/)
    {
    ...
    print OUTFILE "</head>\n";
    print OUTFILE "<body background=\"water.gif\">\n";
    print OUTFILE "<h1 class=\"titletext\">$alias (all meets)</h1>\n";
    if ($alias =~ /Swimmer/) {
        print OUTFILE "<p>(What's up with this <a href=\"names.htm\">name</a>?)</p>"
    }
    print OUTFILE "<hr>\n<table width=\"100%\" class=\"tableClass\">";
...
sub CreateMeetPage
{
    ...
    print OUTFILE "  <link href=\"goteam.css\" rel=\"stylesheet\" type=\"text/css\">\n";
    print OUTFILE "</head>\n";
    print OUTFILE "<body background=\"water.gif\">\n<h1 class=\"titletext\">$mapMeetNumberName{$meet}</h1>\n";
    print OUTFILE "<hr>\n";
    print OUTFILE "<table width=\"100%\" class=\"tableClass\">\n";
    print OUTFILE "<tr><td>Event</td>\n";
    print OUTFILE "    <td>Name</td>\n";
    print OUTFILE "    <td>Place</td>\n";
    print OUTFILE "    <td>Seed</td>\n";
...
sub CreateAlphaPage
{
    ...
    print OUTFILE "  <link href=\"goteam.css\" rel=\"stylesheet\" type=\"text/css\">\n";
    print OUTFILE "</head>\n";
    print OUTFILE "<body background=\"water.gif\">\n<h1  class=\"titletext\">Alphabetical Listing of Swimmers</h1>\n";
    print OUTFILE "<hr><table style=\"tableClass\"><tr><td><ul>\n";
    %tempAliasMap = ();
    $bucketCount = 0;
...
#2015
GatherFromFile("Results20150516_TimeTrials.htm",   "100", "newmeet", "2015 Time Trials - 5/16/2015");
...
GatherFromFile("Results20150627_Crossgates.htm",   "105", "lastmeet", "2015 Santa Teresa vs. Crossgates - 6/27/2015");
#GatherFromFile("Results20150712_Champs.htm",      "106", "newmeet", "2015 Cabana League Championships - 7/11/2015");
